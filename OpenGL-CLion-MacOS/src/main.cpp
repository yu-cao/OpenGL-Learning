...
int main()
{
	...
	glEnable(GL_TEXTURE_CUBE_MAP_SEAMLESS);//为预过滤器映射中的较低mip级别启用无缝立方体贴图采样
	//---------------------------------------
	...
	Shader prefilterShader("shader/PBR/IBL/cubemap.vert","shader/PBR/Specular-IBL/prefilter.frag");
	Shader brdfShader("shader/PBR/Specular-IBL/brdf.vert","shader/PBR/Specular-IBL/brdf.frag");
	...
	//然后让OpenGL从第一个mip face生成mipmap（对抗可见点伪影）
